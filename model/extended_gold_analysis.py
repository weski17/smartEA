...
class GoldDataStatistics:
    ...
    def market_regime_analysis(self):
        ...
        rolling_vol = rolling_vol.reindex(self.df.index, fill_value=rolling_vol.median())
        ...
        ma_condition_up = self.df['MA_50'] > self.df['MA_200']
        ma_condition_down = self.df['MA_50'] < self.df['MA_200']
        
        self.df.loc[ma_condition_up, 'Trend_Regime'] = 'Uptrend'
        self.df.loc[ma_condition_down, 'Trend_Regime'] = 'Downtrend'
